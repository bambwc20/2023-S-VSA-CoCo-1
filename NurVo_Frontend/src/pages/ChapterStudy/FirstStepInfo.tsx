...
export default function FirstStepInfo({navigation, route}: FirstStepInfoProp) {
  ...
  const setIsSpeakingByIndex = (bool: boolean) => {
    setIsSpeaking(bool);
  };
  ...
  return (
    <ScrollView>
      <View style={[layoutStyles.VStackContainer, {paddingHorizontal: 20}]}>
        ...
        <View style={{marginBottom: 60}}>
          <View
            style={[
              ...
              {paddingHorizontal: 20, marginVertical: 12},
            ]}>
            ...
            <TouchableOpacity
              style={[
                layoutStyles.HStackContainer,
                isSpeaking ? styles.playingButton : styles.playButton,
              ]}
        ...
        <TouchableOpacity
          style={[layoutStyles.HStackContainer, styles.studyButton]}
          onPress={handleStart}>
