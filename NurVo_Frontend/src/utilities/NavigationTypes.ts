...
//LessonFirstScreen
type LessonFirstScreenRouteProp = RouteProp<
  HomeStackParamList | ChapterStackParamList,
  'LessonFirstScreen'
>;
...
//LessonSecondScreen
type LessonSecondScreenRouteProp = RouteProp<
  HomeStackParamList | ChapterStackParamList,
  'LessonSecondScreen'
>;
...
//LessonThirdScreen
type LessonThirdScreenRouteProp = RouteProp<
  HomeStackParamList | ChapterStackParamList,
  'LessonThirdScreen'
>;
...
type SelectStepScreenRouteProp = RouteProp<
  HomeStackParamList | ChapterStackParamList,
  'SelectStepScreen'
>;
type SelectStepScreenNavigationProp = NativeStackNavigationProp<
  HomeStackParamList | ChapterStackParamList,
  'SelectStepScreen'
>;
...
type FirstStepInfoRouteProp = RouteProp<
  HomeStackParamList | ChapterStackParamList,
  'FirstStepInfoScreen'
>;
type FirtstStepInfoNavigationProp = NativeStackNavigationProp<
  HomeStackParamList | ChapterStackParamList,
  'FirstStepInfoScreen'
>;
