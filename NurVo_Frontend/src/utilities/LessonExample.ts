...
export const allMessages: Message[] = [
  {
    ...
    speaker: 'Nurse',
    dialogue:
      "Good morning. I'm your nurse, Sarah and I'll be taking care of you today. May I know your name?",
  ...
  },
  {
    ...
    speaker: 'Nurse',
    dialogue:
      "I'm doing great as well. My name is Rachel, and I will be your nurse today.",
    second_step: 'doing great as well',
    korean:
      '저도 기분이 좋아요. 제 이름은 레이첼이고, 오늘은 당신의 간호사가 될 거예요.',
  },
  {
    chapter_id: 1,
    id: 4,
  ...
  },
  {
    ...
    speaker: 'Nurse',
    dialogue:
      'Yes, Mr. Baker. You are going to stay here for the next few days.',
