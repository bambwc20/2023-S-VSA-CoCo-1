...
import {
  FilterDialogues,
  FilterNurse,
  FilterNurse_ThirdStep,
  AccuracyStep2,
  AccuracyStep3,
} from "../services/dialogue.mjs";
...
//step2
async function checkAnswerSecondStep(req, res) {
  //http://localhost:5000/api/dialogues/1/2/step2?id=1 형식으로 post요청해야함
  try {
